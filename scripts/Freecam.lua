...
local function StepFreecam(dt)
	...
	CurrentCamera.Focus = cameraCFrame*CFrame.new(0, 0, -GetFocusDistance(cameraCFrame))
...
local PlayerState = {} do
	...
	function PlayerState.Push()
		...
		cameraFieldOfView = CurrentCamera.FieldOfView
		...
		cameraFocus = CurrentCamera.Focus
	...
	function PlayerState.Pop()
		...
		CurrentCamera.FieldOfView = cameraFieldOfView
		...
		CurrentCamera.Focus = cameraFocus
		cameraFocus = nil
